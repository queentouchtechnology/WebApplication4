...
public partial class add_text_to_image : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string Str_TextOnImage = "யூதா வம்சத்தாரில் தப்பி மீந்திருக்கிறவர்கள் மறுபடியும் கீழே வேர்பற்றி மேலே கனிகொடுப்பார்கள்.";//Your Text On Image
        string Str_TextOnImage2 = "Cross Success";//Your Text On Image
